...
public class ChooseDatabase extends Application implements Initializable {
   ...
   private ObservableList<String> database = FXCollections.observableArrayList("Common","Personal","DemoDevDB"); //
    ...
    public void start(Stage stage)  {
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getClassLoader().getResource("FXML/validationWindow.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void openMainWindow(){
        ...
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getClassLoader().getResource("FXML/"+fxmlFile));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void open() {
        ...
        if(password.isVisible()  && checkPassword(password.getText().hashCode())) {
        ...
        }else if (!password.isVisible()&&comboBox_database.getValue().toString().equals("Common")){
         ...
         fxmlFile = "mainWindow.fxml";
            ...
            }else if (!password.isVisible()&&comboBox_database.getValue().toString().equals("DemoDevDB")){
            Connection.database="demoDevDB.db";
            Connection.setConnection();
            fxmlFile = "mainWindow.fxml";
            openMainWindow();
            isOpened(stage);
